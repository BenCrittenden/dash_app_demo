...
con_scale = dbc.Card(
    [
        ...
        dcc.Slider(min=0, max=100, marks=markers, value=33, id="con_slider"),
    ]
)
lab_scale = dbc.Card(
    [
        html.H3("Labour swing"),
        dcc.Slider(min=0, max=100, marks=markers, value=33, id="lab_slider"),
    ]
)
snp_scale = dbc.Card(
    [
...
ld_scale = dbc.Card(
    [
        ...
        dcc.Slider(min=0, max=100, marks=markers, value=70, id="ld_slider"),
    ]
)
green_scale = dbc.Card(
    [
        html.H3("Green swing"),
        dcc.Slider(min=0, max=100, marks=markers, value=10, id="green_slider"),
    ]
)
pc_scale = dbc.Card(
    [
        html.H3("Plaid Cymru swing"),
        dcc.Slider(min=0, max=100, marks=markers, value=10, id="pc_slider"),
    ]
)

#3. Create a card for the choropleth map 
...
app.layout = dbc.Container(
    children=[
        ...
        #4. add a row for the new choropleth map
    ],
)
...
@app.callback(
    Output(), #1. what goes inside the output brackets here?
    [
        Input("con_slider", "value"),
        Input("lab_slider", "value"),
        Input("snp_slider", "value"),
...
def plot_new_choropleth(
    ...
    layout = go.Layout(
        ...
        mapbox=dict(
            ...
            pitch=0,
            zoom=2, #5. may want to adjust the zoom
            style='dark',
